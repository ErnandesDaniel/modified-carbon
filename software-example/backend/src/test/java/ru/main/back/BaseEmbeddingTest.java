...
/**
 * Базовый класс для интеграционных тестов с реальным EmbeddingService.
 * Использует TestAiConfig для мокирования EmbeddingModel вместо EmbeddingService.
...
@ActiveProfiles("test")
@Transactional
public abstract class BaseEmbeddingTest {
