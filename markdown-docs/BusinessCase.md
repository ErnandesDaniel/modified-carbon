...
- Снижение ежемесячных расходов на 945 992 кредитов (92.8% от текущих).
...
| **Итого** | **1 018 992** | **73 000** | **−945 992** |
...
7.  **Лицензия SCMS (25 000 кредитов):**
    *   *Детализация расходов на поддержку:*
        *   **Хостинг VPS:** 5 000 кредитов/мес (16 ядер, 128 GB RAM, 500 GB SSD — Timeweb Cloud)
        *   **Техническая поддержка:** 15 000 кредитов/мес (мониторинг 24/7, обновления, backup — 0.5 FTE QA Engineer)
        *   **Обслуживание инфраструктуры:** 5 000 кредитов/мес (канал 100 Мбит/с, SSL-сертификаты, резервное копирование, мониторинг)
    *   *Итого:* 25 000 кредитов/мес (включено в стоимость лицензии SCMS)
...
*Накопленный денежный поток по месяцам проекта (февраль 2026 — декабрь 2027). Затраты на разработку приходят ступенями по фазам, экономия начинается после ввода в эксплуатацию (январь 2027).*
...
| Поддержка | 25 000/мес | — | Лицензия SCMS + техподдержка + хостинг (см. детализацию ниже) |
| Инфраструктура и риск-буфер | 320 000 | — | Сервер 20 000 (4 мес) + буфер 300 000 |
| Экономия от внедрения | — | 945 992 | Ежемесячные расходы 1 018 992 → 73 000 |
| **Итого** | **6 000 000** | **945 992/мес** | Окупаемость ≈ 6,3 мес (июль 2027) |

**Детализация ежемесячных расходов на поддержку после внедрения (25 000 кредитов/мес):**

| Компонент поддержки | Стоимость, кредитов/мес | Обоснование |
|---|---|---|
| Хостинг VPS | 5 000 | 16 ядер, 128 GB RAM, 500 GB SSD (Timeweb Cloud) |
| Техническая поддержка | 15 000 | Мониторинг 24/7, обновления, backup (0.5 FTE QA) |
| Обслуживание инфраструктуры | 5 000 | Канал 100 Мбит/с, SSL, backup, мониторинг |
| **ИТОГО** | **25 000** | Включено в стоимость лицензии SCMS |
...
| Дополнительные издержки (ошибки, штрафы, потери) | 904 992 | 47 000 |
| Лицензия системы | 0 | 25 000 |
| **Общие ежемесячные расходы** | **1 018 992** | **73 000** |
...
| 11 (янв 2027) | Экономия | −5 054 008 |
| 12 (фев 2027) | Экономия | −4 108 016 |
| 13 (мар 2027) | Экономия | −3 162 024 |
| 14 (апр 2027) | Экономия | −2 216 032 |
| 15 (май 2027) | Экономия | −1 270 040 |
| 16 (июн 2027) | Экономия | −324 048 |
| 17 (июл 2027) | **Точка окупаемости** | **+621 944** |
| 18 (авг 2027) | Экономия | +1 567 936 |
| 19 (сен 2027) | Экономия | +2 513 928 |
| 20 (окт 2027) | Экономия | +3 459 920 |
| 21 (ноя 2027) | Экономия | +4 405 912 |
| 22 (дек 2027) | Экономия | +5 351 904 |

**Расчёт окупаемости:**

- Затраты на разработку: 6 000 000 кредитов (приходят ступенями в феврале — декабре 2026).
- Экономия: 945 992 кредитов/мес, начинается с января 2027 (после ввода в эксплуатацию).
- Срок окупаемости с момента ввода: 6 000 000 / 945 992 ≈ 6,34 месяца → **июль 2027**.
- От старта проекта: ≈ 17 месяцев.

**ROI (коэффициент возврата инвестиций) за 3 года:**

- Совокупная экономия за 36 месяцев: 945 992 × 36 = 34 055 712 кредитов.
- Общие инвестиции: 6 000 000 кредитов.
- Чистая прибыль: 34 055 712 − 6 000 000 = 28 055 712 кредитов.
- ROI: (34 055 712 − 6 000 000) / 6 000 000 × 100 % = **467,6 %**.

**Вывод:** затраты на разработку (6 000 000 кредитов) приходят ступенями в течение 2026 года; система вводится в эксплуатацию в декабре 2026, экономия 945 992 кредитов/мес начинается с января 2027. Накопленный денежный поток пересекает ноль примерно через **6,34 месяца эксплуатации (июль 2027)**. За трёхлетний период совокупный экономический эффект — 34 055 712 кредитов, ROI — 467,6 %.
