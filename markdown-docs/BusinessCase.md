...
- Снижение ежемесячных расходов на 966 000 кредитов (90.8% от текущих).
...
| **Итого** | **1 064 000** | **98 000** | **−966 000** |
...
| Фаза | Трудозатраты, ч | Доля | Сумма, кредитов | На что расходуется |
|------|-----------------|------|-----------------|-------------------|
...
|-----------|--------------------------|--------------------------|
| Операционные издержки ручного управления | 114 000 | 8 000 |
| Дополнительные издержки (ошибки, штрафы, потери) | 950 000 | 65 000 |
...
![ROI — Окупаемость SCMS](../use-case-diagrams/roi-chart.png)

*Диаграмма окупаемости: накопленный финансовый результат по месяцам. Красным — убытки, зелёным — прибыль. Точка окупаемости — месяц 6–7.*
