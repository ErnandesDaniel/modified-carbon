...
//Откуда простой персонала 80к рублей, точно указать расчеты причины
...
//Расходы на поддержку системы, сервера
//расходы на поддержку нужны такие чтобы команда разработки была бы обосанована
