...
#figure(
  image("../use-case-diagrams/diagram-02-neuro-operations.png", width: 85%),
  caption: [Диаграмма 2 — Модуль нейро-операций (перенос и валидация). Акторы: Needlecaster и Psychosurgeon. Прецеденты: управление реестром стеков, мониторинг needlecast, тестирование после пробуждения, календарь операций, 72-часовая проверка, сертификация совместимости, диагностика проблем переноса, ведение мед. карты.]
)
